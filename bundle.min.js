...
);const box = cmz('box', [null, null, null, widerThan(600, 'color: lightseagreen'), widerThan(800, 'color: royalblue'), widerThan(1024, 'color: coral')]
...
);const smallText = cmz('src_demo-51', [box, fontSize(1), null]
