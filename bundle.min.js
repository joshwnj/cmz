...
const shadow = cmz('src_demo-5', null);const BASE_SIZE = 16;
...
const boxVariants = {
  small: cmz('src_demo-18', null),
  medium: cmz('src_demo-19', null),
  large: cmz('src_demo-20', null)

  // you can create an atom by combining css rules:
};const box = cmz('box', [null, null, null,
...
);module.exports.shadow = cmz('src_effects-4', null);

const makeItRed = cmz('src_effects-8', null);

module.exports.pulse = cmz('src_effects-10', [makeItRed, null]);

module.exports.spin = cmz('src_effects-24', null);
